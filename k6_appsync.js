...
const REALTIME_ENDPOINT = `wss://${realtime_api_host}:443/graphql?header=${header}&payload=e30=`;
const HTTP_ENDPOINT     = `https://${http_api_host}/graphql`;

let ramp_up_duration   = 1,  // 在x秒内建立 *target* 个ws连接
...
export function listener() {
  ...
  const params = { headers:{"Sec-WebSocket-Protocol": "graphql-ws"}, tags: { my_tag: "appsync" } };
